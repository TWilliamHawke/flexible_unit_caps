...
Flexible_unit_caps.unit_group_caps = {
  ...
  fluc_kho_daemons = { 8, "wh3_dlc20_chs_inf_forsaken_mkho" },
  ...
  fluc_sla_daemons = { 8, "wh3_dlc20_chs_inf_forsaken_msla" },
  ...
  fluc_nur_daemons = { 8, "wh3_main_nur_inf_nurglings_0" },
  ...
  fluc_tze_daemons = { 8, "wh3_main_tze_inf_blue_horrors_0" },

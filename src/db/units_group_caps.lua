...
Flexible_unit_caps.unit_group_caps = {
  ...
  fluc_bst_pestigors = { 8, "" },
  --Bretonnia
  fluc_brt_artillery = { 4, "wh_main_brt_inf_men_at_arms" },
  fluc_brt_errant = { 4, "wh_main_brt_inf_spearmen_at_arms" },
  fluc_brt_pegasus = { 4, "wh_dlc07_brt_inf_battle_pilgrims_0" },
  fluc_brt_hippogryph = { 4, "wh_main_brt_cav_pegasus_knights" },
  fluc_brt_grail = { 4, "wh_main_brt_cav_knights_of_the_realm" },
  fluc_brt_militia = { 10, "" },
  fluc_brt_questing = { 4, "wh_dlc07_brt_inf_foot_squires_0" },
  fluc_brt_peasants = { 10, "wh_dlc07_brt_inf_men_at_arms_1" },
  fluc_brt_peasant_bowmen = { 6, "wh_dlc07_brt_inf_spearmen_at_arms_1" },
  fluc_brt_piligrims = { 6, "wh_dlc07_brt_inf_men_at_arms_2" },
  fluc_brt_realm = { 4, "wh_main_brt_cav_mounted_yeomen_0" },
  fluc_brt_squires = { 6, "wh_dlc07_brt_inf_men_at_arms_2" },
  fluc_brt_yeomen = { 6, "wh_main_brt_inf_spearmen_at_arms" },
  fluc_brt_guardians = { 4, "wh_dlc07_brt_inf_battle_pilgrims_0" },
  fluc_brt_questing_vow = { 6, "wh_dlc07_brt_inf_foot_squires_0" },
  fluc_brt_knight_vow = { 6, "wh_main_brt_inf_spearmen_at_arms" },
  fluc_brt_grail_vow = { 6, "wh_dlc07_brt_inf_battle_pilgrims_0" },
  --Chaos dwarfs
  ...
  fluc_chd_blunderbusses = { 6, "wh3_dlc23_chd_inf_chaos_dwarf_warriors" },
  fluc_chd_fireglaves = { 4, "wh3_dlc23_chd_inf_infernal_guard" },
  ...
  fluc_chd_lammasu = { 4, "wh3_dlc23_chd_inf_chaos_dwarf_warriors_great_weapons" },
  ...
  fluc_cst_mournguls = { 4, "wh2_dlc11_cst_mon_animated_hulks_0" },
  fluc_cst_necrofex = { 4, "wh2_dlc11_cst_inf_deck_gunners_0" },
  ...
  fluc_cth_crain_gunners = { 4, "wh3_main_cth_inf_jade_warriors_1" },
  fluc_cth_celestian_lions = { 4, "wh3_dlc24_cth_inf_onyx_crowmen" },
  fluc_cth_crossbowmen = { 6, "wh3_main_cth_inf_jade_warriors_0" },
  fluc_cth_crowmen = { 6, "wh3_main_cth_inf_peasant_spearmen_1" },
  fluc_cth_dragon_guard = { 6, "wh3_main_cth_inf_jade_warriors_1" },
  fluc_cth_hail_gunners = { 6, "wh3_main_cth_inf_peasant_spearmen_1" },
  fluc_cth_horsemen = { 6, "wh3_main_cth_inf_peasant_spearmen_1" },
  fluc_cth_jade_warriors = { 8, "" },
  ...
  fluc_cth_moon_birds = { 4, "wh3_dlc24_cth_inf_onyx_crowmen" },
  ...
  fluc_def_executioners = { 6, "wh2_main_def_inf_black_ark_corsairs_0" },
  ...
  fluc_def_monsters = { 4, "" },
  fluc_def_scourgerunner = { 4, "wh2_main_def_inf_dreadspears_0" },
  fluc_def_shades = { 6, "wh2_main_def_inf_black_ark_corsairs_0" },
  fluc_def_sisters = { 6, "wh2_main_def_inf_witch_elves_0" },
  fluc_def_witch_elves = { 8, "wh2_main_def_inf_bleakswords_0" },
  --Dwarfs
  fluc_dwf_artillery = { 4, "wh_main_dwf_inf_miners_1" },
  fluc_dwf_artillery_classic = { 4, "wh_main_dwf_inf_dwarf_warrior_0" },
  fluc_dwf_artillery_fire = { 4, "wh_main_dwf_inf_miners_1" },
  fluc_dwf_artillery_gun = { 4, "wh_main_dwf_inf_miners_1" },
  fluc_dwf_elo_attack = { 6, "wh_main_dwf_inf_miners_0_grey_supply" },
  fluc_dwf_elo_defence = { 6, "wh_main_dwf_inf_miners_0_grey_supply" },
  fluc_dwf_flying_machine = { 6, "wh_main_dwf_inf_miners_1" },
  fluc_dwf_golem = { 4, "wh_main_dwf_inf_longbeards" },
  fluc_dwf_hammerers = { 6, "wh_main_dwf_inf_longbeards_1" },
  fluc_dwf_huskarls = { 6, "wh_main_dwf_inf_dwarf_warrior_0" },
  fluc_dwf_ironbreakers = { 6, "wh_main_dwf_inf_longbeards" },
  fluc_dwf_irondrakes = { 4, "wh_main_dwf_inf_miners_1" },
  fluc_dwf_land_machine = { 4, "wh_main_dwf_inf_dwarf_warrior_1" },
  ...
  fluc_dwf_pirates = { 6, "wh_main_dwf_inf_dwarf_warrior_0" },
  fluc_dwf_goblin_hewers = { 4, "wh_main_dwf_inf_dwarf_warrior_1" },
  fluc_dwf_thunderbarge = { 4, "wh_main_dwf_inf_ironbreakers" },
  fluc_dwf_copters = { 6, "wh_main_dwf_inf_miners_0" },
  fluc_dwf_bombers = { 4, "wh_main_dwf_inf_ironbreakers" },
  -- Empire
  fluc_emp_archers = { 6, "wh_main_emp_inf_spearmen_0" },
  fluc_emp_artillery = { 4, "wh2_dlc13_emp_veh_war_wagon_0" },
  fluc_emp_artillery_wagon = { 4, "wh2_dlc13_emp_veh_war_wagon_0" },
  fluc_emp_blazing_sun = { 4, "wh_main_emp_inf_spearmen_1" },
  fluc_emp_crossbowmen = { 6, "wh_main_emp_inf_spearmen_1" },
  fluc_emp_demigryph = { 4, "wh_main_emp_inf_halberdiers" },
  ...
  fluc_emp_huntsmen = { 6, "wh_main_emp_inf_spearmen_1" },
  fluc_emp_knight_white_wolf = { 4, "wh_main_emp_cav_empire_knights" },
  fluc_emp_knights_emp = { 4, "wh_main_emp_inf_halberdiers" },
  fluc_emp_knights_orders = { 4, "wh_main_emp_cav_empire_knights" },
  ...
  fluc_emp_ulric_cult = { 6, "fluc_emp_flagellants" },
  fluc_emp_wagon = { 6, "wh_main_emp_inf_spearmen_1" },
  fluc_emp_long_rifles = { 4, "wh_main_emp_inf_handgunners" },
  fluc_emp_landship = { 4, "wh_main_emp_cav_pistoliers_1" },
  fluc_emp_gunpowder = { 6, "" }, --tooltip only
  fluc_emp_helstorm = { 4, "wh_main_emp_inf_handgunners" },
  --Greenskins
  ...
  fluc_grn_squig = { 6, "wh_main_grn_inf_goblin_spearmen" },
  fluc_grn_trolls = { 6, "wh_main_grn_inf_orc_boyz" },
  fluc_grn_wagon = { 4, "wh_main_grn_inf_orc_boyz" },
  fluc_grn_wyverns = { 4, "wh_main_grn_inf_orc_boyz" },
  --Hight Elves
  ...
  fluc_hef_eagles = { 6, "wh2_dlc15_hef_inf_rangers_0" },
  ...
  fluc_hef_trees = { 6, "wh2_dlc10_hef_inf_dryads_0" },
  --Kislev
  ...
  fluc_ksl_kossars = { 10, "" },
  fluc_ksl_kossars_spears = { 8, "wh3_main_ksl_inf_kossars_0" },
  ...
  fluc_ksl_warriors = { 8, "" },
  fluc_ksl_frost_wyrm = { 4, "wh3_main_ksl_mon_snow_leopard_0" },
  --Khorne
  ...
  fluc_lzd_feral_cold_one = { 6, "wh2_main_lzd_inf_skink_cohort_0" },
  ...
  fluc_nur_pestigors = { 8, "" },
  fluc_nur_ogres = { 6, "" },
  fluc_nur_rot_knights = { 4, "wh3_main_nur_mon_plague_toads_0" },
  fluc_nur_trolls = { 6, "wh3_main_nur_mon_plague_toads_0" },
  fluc_nur_toad_dragons = { 4, "wh3_main_nur_inf_plaguebearers_0" },
  ...
  fluc_skv_catapults = { 4, "wh2_main_skv_inf_plague_monks" },
  ...
  fluc_skv_lightning = { 4, "wh2_main_skv_inf_death_globe_bombardiers" },
  fluc_skv_melee_runners = { 6, "wh2_main_skv_inf_clanrats_1" },
  fluc_skv_missile_runners = { 6, "wh2_main_skv_inf_night_runners_1" },
  fluc_skv_monsters = { 4, "wh2_dlc16_skv_mon_wolf_rats_0" },
  fluc_skv_mortars = { 4, "wh2_main_skv_inf_death_globe_bombardiers" },
  fluc_skv_neck_cutters = { 4, "wh2_main_skv_inf_clanrats_1" },
  fluc_skv_plague_monks = { 6, "wh2_main_skv_inf_clanrats_1" },
  fluc_skv_ratlings = { 4, "wh2_main_skv_inf_stormvermin_1" },
  ...
  fluc_skv_stormvermin = { 8, "wh2_main_skv_inf_clanrats_1" },
  fluc_skv_triads = { 8, "wh2_main_skv_inf_clanrat_spearmen_1" },
  fluc_skv_warp_grinder = { 4, "wh2_main_skv_inf_clanrats_1" },
  fluc_skv_warpfire_thrower = { 4, "wh2_main_skv_inf_clanrat_spearmen_1" },
  fluc_skv_weapon_teams = { 8, "wh2_main_skv_inf_death_globe_bombardiers" },
  ...
  --Vampire counts
  fluc_vmp_black_knights = { 4, "wh_main_vmp_inf_skeleton_warriors_1" },
  ...
  fluc_vmp_ghouls = { 10, "wh_main_vmp_inf_skeleton_warriors_0" },
  fluc_vmp_grave_guard = { 6, "wh_main_vmp_inf_crypt_ghouls" },
  fluc_vmp_lahmian = { 6, "wh_main_vmp_inf_skeleton_warriors_0" },
  fluc_vmp_machines = { 4, "wh_main_vmp_inf_zombie" },
  fluc_vmp_mortals = { 10, "" },
  fluc_vmp_skeletons = { 10, "" },
  fluc_vmp_terrorgheist = { 4, "wh_main_vmp_mon_vargheists" },
  ...
  fluc_vmp_zombies = { 10, "" },
  --Wood elves
  fluc_wef_archers = { 8, "wh_dlc05_wef_inf_eternal_guard_1" }, --for ai
  fluc_wef_deepwood_scouts = { 6, "wh_dlc05_wef_inf_eternal_guard_1" },
  fluc_wef_dragons = { 4, "wh_dlc05_wef_mon_great_eagle_0" },
  fluc_wef_dryads = { 10, "" },
  fluc_wef_eternal_guard = { 10, "" },
  fluc_wef_feral = { 6, "wh2_dlc16_wef_mon_wolves_0" },
  fluc_wef_glade_guard = { 6, "wh_dlc05_wef_inf_eternal_guard_1" },
  fluc_wef_hawks = { 4, "wh_dlc05_wef_inf_wardancers_0" },
  fluc_wef_light_cav = { 6, "wh_dlc05_wef_inf_eternal_guard_1" },
  fluc_wef_rangers = { 6, "wh_dlc05_wef_inf_wardancers_0" },
  fluc_wef_sisters_thorn = { 4, "wh_dlc05_wef_inf_wardancers_0" },
  fluc_wef_spiders = { 6, "" },
  fluc_wef_stag_cav = { 4, "wh_dlc05_wef_inf_wardancers_0" },

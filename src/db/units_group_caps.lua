...
Flexible_unit_caps.unit_group_caps = {
  ...
  fluc_skv_catapults = { 4, "" }, --overwrited by fluc_skv_artillery
  ...
  fluc_skv_lightning = { 4, "" }, --overwrited by fluc_skv_artillery
  ...
  fluc_skv_mortars = { 4, "" }, --overwrited by fluc_skv_artillery

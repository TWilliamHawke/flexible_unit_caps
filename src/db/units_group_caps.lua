...
Flexible_unit_caps.unit_group_caps = {
  ...
  fluc_dwf_thunderbarge = { 4, "wh_main_dwf_veh_gyrocopter_0" },
  fluc_dwf_copters = { 6, "wh_main_dwf_inf_miners_0" },
  fluc_dwf_bombers = { 4, "wh_main_dwf_inf_miners_1" },
  -- Empire
  ...
  fluc_emp_knight_white_wolf = { 4, "wh_main_emp_inf_halberdiers" },
  fluc_emp_knights_emp = { 4, "wh_main_emp_inf_halberdiers" },
  fluc_emp_knights_orders = { 4, "wh_main_emp_inf_halberdiers" },

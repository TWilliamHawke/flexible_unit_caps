...
Flexible_unit_caps.skill_supply_change = {
  ...
  wh_main_emp_karl_franz = {
    fluc_emp_knight_white_wolf = { -2, true, "wh_dlc08_skill_emp_lord_unique_karl_3" },
    fluc_emp_knights_emp = { -2, false, "wh_dlc08_skill_emp_lord_unique_karl_3" },
    fluc_emp_knights_orders = { -2, false, "wh_dlc08_skill_emp_lord_unique_karl_3" },
    fluc_emp_foot_reiksguard = { -1, false, "wh_dlc08_skill_emp_lord_unique_karl_3" },
  },
  ...
  wh_main_emp_lord = {
    fluc_emp_demigryph = { -1, false, "wh3_dlc25_skill_emp_lord_general_special_6" },
    fluc_emp_knight_white_wolf = { -1, true, "wh3_dlc25_skill_emp_lord_general_special_6" },
    fluc_emp_knights_emp = { -1, false, "wh3_dlc25_skill_emp_lord_general_special_6" },
    fluc_emp_knights_orders = { -1, false, "wh3_dlc25_skill_emp_lord_general_special_6" },
    fluc_emp_outriders = { -1, false, "wh3_dlc25_skill_emp_lord_general_special_6" },
    fluc_emp_reiksguard = { -1, false, "wh3_dlc25_skill_emp_lord_general_special_6" },
  },
  wh_dlc04_emp_arch_lector = {
    fluc_emp_flagellants = { -1, false, "wh_main_skill_emp_dignitary_unique_warrior_priest_righteous_fury" },
  },
  ...
  wh3_dlc20_chs_lord_mkho = {
    fluc_kho_warriors = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_kho_knights = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_kho_chosen = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
  },
  wh3_dlc20_chs_lord_msla = {
    fluc_sla_warriors = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_sla_knights = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_sla_chosen = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
  },
  wh3_dlc24_chs_lord_mtze = {
    fluc_tze_warriors = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_tze_knights = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_tze_chosen = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
  },
  wh3_dlc25_chs_lord_mnur = {
    fluc_nur_warriors = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_nur_knights = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_nur_chosen = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
  },
  wh_main_chs_lord = {
    fluc_chs_warriors = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_chs_knights = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
    fluc_chs_chosen = { -1, false, "wh3_dlc20_skill_chs_lord_generic_3" },
  },
  wh3_dlc20_chs_sorcerer_lord_death_mnur = {
    fluc_nur_forsaken = { -1, false, "wh3_dlc20_skill_chs_sorcerer_lord_generic_3" },
    fluc_nur_spawn = { -1, false, "wh3_dlc20_skill_chs_sorcerer_lord_generic_3" },
  },
  ...
  wh_dlc01_chs_sorcerer_lord_death = {
    fluc_chs_forsaken = { -1, false, "wh3_dlc20_skill_chs_sorcerer_lord_generic_3" },
    fluc_chs_spawn = { -1, false, "wh3_dlc20_skill_chs_sorcerer_lord_generic_3" },
  },
  ...
  wh3_main_tze_kairos = {
    fluc_tze_lord_of_change = { -2, false, "wh3_main_skill_tze_kairos_self_4" },
  },
  wh3_dlc20_chs_sorcerer_lord_metal_mtze = {
    fluc_tze_forsaken = { -1, false, "wh3_dlc20_skill_chs_sorcerer_lord_generic_3" },
    fluc_tze_spawn = { -1, false, "wh3_dlc20_skill_chs_sorcerer_lord_generic_3" },
  },

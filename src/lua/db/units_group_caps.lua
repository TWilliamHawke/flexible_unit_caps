Flexible_unit_caps.unit_group_caps = {
  ...
  fluc_cst_prometheans_melee = { 4, "wh2_dlc11_cst_inf_zombie_deckhands_mob_0" },
  fluc_cst_prometheans_missile = { 4, "wh2_dlc11_cst_inf_zombie_deckhands_mob_0" },
  ...
  fluc_def_cold_one = { 4, "wh2_main_def_inf_bleakswords_0" },
  ...
  fluc_def_darkshards = { 6, "wh2_main_def_inf_dreadspears_0" },
  fluc_def_doomfire = { 4, "wh2_main_def_inf_dreadspears_0" },
  ...
  fluc_dwf_land_machine = { 4, "" }, --replaced
  fluc_dwf_longbeards = { 8, "wh_main_dwf_inf_dwarf_warrior_0" },
  fluc_dwf_miners = { 10, "" },
  fluc_dwf_quarrellers = { 6, "wh_main_dwf_inf_dwarf_warrior_0" },
  ...
  fluc_emp_blazing_sun = { 4, "" }, --replaced
  fluc_emp_crossbowmen = { 6, "" }, --replaced
  fluc_emp_demigryph = { 4, "" }, --replaced
  fluc_emp_dismounted_knights = { 6, "wh_main_emp_inf_swordsmen" },
  fluc_emp_flagellants = { 6, "" },
  fluc_emp_free_company = { 8, "wh_main_emp_inf_swordsmen" },
  fluc_emp_greatswords = { 6, "wh_main_emp_inf_swordsmen" },
  fluc_emp_halberdiers = { 8, "" }, --replaced
  fluc_emp_handgunners = { 6, "wh_main_emp_inf_swordsmen" },
  fluc_emp_huntsmen = { 6, "" }, --replaced
  fluc_emp_knight_white_wolf = { 4, "" }, --replaced
  fluc_emp_knights_emp = { 4, "" }, --replaced
  fluc_emp_knights_other = { 4, "wh_main_emp_inf_spearmen_1" },
  ...
  fluc_grn_other_monsters = { 4, "" }, --very rare
  fluc_grn_savage = { 10, "" },
  ...
  fluc_lzd_cold_one = { 4, "wh2_main_lzd_inf_saurus_spearmen_0" },
  fluc_lzd_dread_saurian = { 4, "wh2_main_lzd_cav_cold_ones_feral_0" },
  fluc_lzd_kroxigors = { 4, "wh2_main_lzd_inf_saurus_warriors_0" },
  fluc_lzd_razordons = { 4, "wh2_main_lzd_inf_skink_cohort_1" },
  fluc_lzd_ripperdactyl = { 4, "wh2_main_lzd_inf_saurus_warriors_0" },
  fluc_lzd_salamanders = { 4, "wh2_main_lzd_inf_skink_cohort_1" },
  fluc_lzd_saurus = { 8, "" },
  fluc_lzd_skinks = { 10, "" },
  ...
  fluc_nor_flying_beasts = { 4, "" },
  fluc_nor_giants = { 4, "wh_main_nor_mon_chaos_trolls" },
  fluc_nor_horsemen = { 6, "wh_main_nor_cav_marauder_horsemen_0" },
  fluc_nor_hounds = { 6, "wh_main_nor_inf_chaos_marauders_0" },
  fluc_nor_mammoths = { 4, "wh_main_nor_mon_chaos_trolls" },
  ...
  fluc_skv_lightning = { 0, "" }, --overwrited by fluc_skv_artillery
  ...
  fluc_skv_mortars = { 0, "" }, --overwrited by fluc_skv_artillery
  ...
  fluc_skv_slaves = { 15, "" },
  fluc_skv_stormfiend = { 6, "wh2_main_skv_mon_rat_ogres" },
  fluc_skv_stormvermin = { 6, "wh2_main_skv_inf_clanrats_0" },
  fluc_skv_triads = { 6, "wh2_main_skv_inf_clanrat_spearmen_1" },
  ...
  fluc_vmp_crypt_horrors = { 4, "wh_main_vmp_inf_crypt_ghouls" },
  fluc_vmp_forest = { 6, "wh_main_vmp_inf_zombie" },
  ...
  fluc_wef_trees = { 6, "wh_dlc05_wef_inf_dryads_0" },
  ...
  fluc_cth_archers = { 8, "wh3_main_cth_inf_peasant_spearmen_1" },
  fluc_cth_horsemen = { 6, "wh3_main_cth_inf_peasant_spearmen_1" },
  fluc_cth_crossbowmen = { 8, "wh3_main_cth_inf_peasant_archers_0" },
  ...
  fluc_kho_warriors = { 8, "wh3_dlc20_chs_inf_chaos_marauders_mkho" },
  fluc_kho_chosen = { 6, "wh3_main_kho_inf_chaos_warriors_0" },
  fluc_kho_war_machines = { 6, "wh3_dlc20_chs_cav_marauder_horsemen_mkho_throwing_axes" },
  fluc_kho_daemons = { 8, "" },
  fluc_kho_exalted_daemons = { 6, "wh3_main_kho_inf_bloodletters_0" },
  fluc_kho_greater_daemons = { 4, "wh3_main_kho_inf_bloodletters_1" },
  ...
  fluc_sla_hounds = { 6, "wh3_dlc20_chs_inf_chaos_marauders_msla" },
  fluc_sla_forsaken = { 8, "wh3_dlc20_chs_inf_chaos_marauders_msla" },
  fluc_sla_warriors = { 8, "wh3_dlc20_chs_inf_chaos_marauders_msla" },
  fluc_sla_chosen = { 6, "wh3_dlc20_chs_cav_chaos_chariot_msla" },
  fluc_sla_war_machines = { 6, "wh3_dlc20_chs_inf_chaos_marauders_msla" },
  fluc_sla_daemons = { 8, "" },
  fluc_sla_exalted_daemons = { 6, "wh3_main_sla_inf_daemonette_0" },
  fluc_sla_greater_daemons = { 4, "wh3_main_sla_inf_daemonette_1" },
  fluc_sla_knights = { 4, "wh3_dlc20_chs_inf_chaos_marauders_msla" },
  fluc_sla_fiends = { 4, "wh3_dlc20_chs_inf_chaos_marauders_msla" },
  ...
  fluc_nur_warriors = { 8, "wh3_dlc20_chs_inf_chaos_warriors_mnur" },
  fluc_nur_chosen = { 6, "wh3_dlc20_chs_cav_chaos_chariot_msla" },
  fluc_nur_war_machines = { 6, "wh3_dlc20_chs_inf_chaos_marauders_mnur" },
  fluc_nur_daemons = { 8, "" },
  fluc_nur_exalted_daemons = { 6, "wh3_main_nur_inf_plaguebearers_0" },
  fluc_nur_greater_daemons = { 4, "wh3_main_nur_inf_plaguebearers_0" },
  fluc_nur_knights = { 4, "wh3_dlc20_chs_inf_chaos_marauders_mnur" },
  fluc_nur_flies = { 4, "wh3_dlc20_chs_inf_chaos_marauders_mnur" },
  ...
  fluc_tze_warriors = { 8, "wh3_dlc20_chs_inf_chaos_warriors_mnur" },
  fluc_tze_chosen = { 6, "wh3_dlc20_chs_cav_chaos_chariot_msla" },
  fluc_tze_war_machines = { 6, "wh3_dlc20_chs_inf_chaos_marauders_mtze" },
  fluc_tze_daemons = { 8, "" },
  fluc_tze_exalted_daemons = { 6, "wh3_main_tze_inf_pink_horrors_0" },
  fluc_tze_greater_daemons = { 4, "wh3_main_tze_inf_pink_horrors_0" },
  fluc_tze_knights = { 4, "wh3_dlc20_chs_inf_chaos_marauders_mtze" },
  fluc_tze_flamers = { 4, "wh3_dlc20_chs_inf_chaos_marauders_mtze" },
  ...
  fluc_chs_trolls = { 6, "wh_main_chs_inf_chaos_marauders_0" },
  fluc_chs_forsaken = { 6, "wh_main_chs_inf_chaos_marauders_0" },
  fluc_chs_war_machines = { 6, "wh_main_chs_inf_chaos_marauders_0" },
  fluc_chs_dragon_ogres = { 6, "wh_main_chs_inf_chaos_marauders_0" },
  fluc_chs_knights = { 4, "wh_main_chs_cav_marauder_horsemen_0" },
  fluc_chs_spawn = { 4, "wh_dlc01_chs_inf_forsaken_0" },
  fluc_chs_warriors = { 8, "wh_main_chs_inf_chaos_marauders_0" },
  fluc_chs_chosen = { 6, "wh_main_chs_inf_chaos_warriors_0" },
  fluc_chs_daemons = { 8, "" }, --player only
  fluc_chs_exalted_daemons = { 6, "" }, --player only

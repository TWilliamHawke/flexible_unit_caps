function Flexible_unit_caps:get_queued_units_count(target_unit_group, target_unit_index)
  ...
  local unit_component = find_uicomponent(core:get_ui_root(), "main_units_panel", "units", "QueuedLandUnit 0");
  ...
  while (unit_component) do
    ...
    unit_component = find_uicomponent(core:get_ui_root(), "main_units_panel", "units", "QueuedLandUnit "..iteration_index);
  end;
